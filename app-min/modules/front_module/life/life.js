...
angular.module('myApp.life', ['ui.router'])


    .controller('LifeCtrl', ['$rootScope','$scope','locals','$state','$stateParams','$http','$compile','$location','$anchorScroll',function($rootScope,$scope,locals,$state,$stateParams,$http,$compile,$location,$anchorScroll) {

            if(locals.getObj('lifePosts',1000*3600*24*3)){
                var posts=locals.getObj('lifePosts',1000*3600*24*3);
                var countPost=20;
                ...
                for( r=0;r<posts.length;r++){
                    if(posts[r].postId=='1513001937996'){
