...
angular.module('myApp.car', ['ui.router'])


    .controller('CarCtrl', ['$rootScope','$scope','locals','$state','$stateParams','$http','$compile','$location','$anchorScroll',function($rootScope,$scope,locals,$state,$stateParams,$http,$compile,$location,$anchorScroll) {
            if(locals.getObj('carPosts',1000*3600*3)){
                var posts=locals.getObj('carPosts',1000*3600*3);
                var countPost=20;
                ...
                for( r=0;r<posts.length;r++){
                    if(posts[r].postId=='1513003717043'){
            ...
            //获取数据
            $http({url:'http://localhsot:3000/label_posts',
                params:{label:'汽车'},
                method:'GET',
