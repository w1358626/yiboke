...
angular.module('myApp.travel', ['ui.router'])


    .controller('TravelCtrl', ['$rootScope','$scope','locals','$state','$stateParams','$http','$compile','$location','$anchorScroll',function($rootScope,$scope,locals,$state,$stateParams,$http,$compile,$location,$anchorScroll) {

            if(locals.getObj('travelPosts',1000*3600*24*3)){
                var posts=locals.getObj('travelPosts',1000*3600*24*3);
                var countPost=20;
                ...
                for( r=0;r<posts.length;r++){
                    if(posts[r].postId=='1513335857091'){
            ...
            $http({url:'http://localhost:3000/label_posts',
                ...
                locals.setObj('travelPosts',posts);
                var countPost=20;
                $scope.noMore_show=false;
                $scope.load_show=true;
                var ul1=angular.element(document.querySelectorAll('#artUl1'));
