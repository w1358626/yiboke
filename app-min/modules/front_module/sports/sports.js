...
angular.module('myApp.sports', ['ui.router'])


    .controller('SportsCtrl', ['$rootScope','$scope','locals','$state','$stateParams','$http','$compile','$location','$anchorScroll',function($rootScope,$scope,locals,$state,$stateParams,$http,$compile,$location,$anchorScroll) {

            if(locals.getObj('sportsPosts',1000*3600*24*3)){
                var posts = locals.getObj('sportsPosts',1000*3600*24*3);
                var countPost = 20;
                ...
                $http({
                    url: 'http://www.yblog.site:3000/label_posts',
                    params: {label:'运动'},
                    method: 'GET',
                    ...
                    locals.setObj('sportsPosts',posts);
                    var countPost = 20;
                    $scope.noMore_show = false;
                    $scope.load_show = true;
                    var ul1 = angular.element(document.querySelectorAll('#artUl1'));
