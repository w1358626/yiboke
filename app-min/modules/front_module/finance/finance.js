...
angular.module('myApp.finance', ['ui.router'])


    .controller('FinanceCtrl', ['$rootScope','$scope','locals','$state','$stateParams','$http','$compile','$location','$anchorScroll',function($rootScope,$scope,locals,$state,$stateParams,$http,$compile,$location,$anchorScroll) {
            if(locals.getObj('financePosts',1000*3600*24*3)){
                var posts=locals.getObj('financePosts',1000*3600*24*3);
                var countPost=20;
                ...
                for( r=0;r<posts.length;r++){
                    if(posts[r].postId=='1513004619953'){
            ...
            $http({url:'http://localhost:3000/label_posts',
                ...
                locals.setObj('financePosts',posts);
                var countPost=20;
                $scope.noMore_show=false;
                $scope.load_show=true;
                var ul1=angular.element(document.querySelectorAll('#artUl1'));
