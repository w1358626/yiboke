...
angular.module('myApp.science', ['ui.router'])
    ...
    .controller('ScienceCtrl', ['$rootScope','$scope','locals','$state','$stateParams','$http','$compile','$location','$anchorScroll',function($rootScope,$scope,locals,$state,$stateParams,$http,$compile,$location,$anchorScroll) {

            if(!locals.getObj('sciencePosts',1000*3600*24*3)){
                var posts=locals.getObj('sciencePosts',1000*3600*24*3);
                var countPost=20;
                ...
                for( r=0;r<posts.length;r++){
                    if(posts[r].postId=='1513340514716'){
            ...
            $http({url:'http://localhost:3000/label_posts',
                ...
                locals.setObj('sciencePosts',posts);
                var countPost=20;
                $scope.noMore_show=false;
                $scope.load_show=true;
                var ul1=angular.element(document.querySelectorAll('#artUl1'));
