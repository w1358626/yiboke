...
angular.module('myApp.art', ['ui.router'])


    .controller('ArtCtrl', ['$rootScope','$scope','locals','$state','$stateParams','$http','$compile',function($rootScope,$scope,locals,$state,$stateParams,$http,$compile) {
            if(locals.getObj('artPosts',1000*3600*24*3)){
                var posts=locals.getObj('artPosts',1000*3600*24*3);
                var countPost=20;
                ...
                for( r=0;r<posts.length;r++){
                    if(posts[r].postId=='1513004009618'){
